...
<!--
<a href="https://www.gitanimals.org/en_US?utm_medium=image&utm_source=hayeoniill&utm_content=farm">
<img
  src="https://render.gitanimals.org/farms/hayeoniill"
  width="600"
  height="300"
/>
</a>
...
### 🦁 멋쟁이사자처럼 (LikeLion) — Frontend Developer  
...
- 🏫 **학교 축제(대동제) 웹사이트** — [ARETEUM Festival Web](https://github.com/seul99/2025ARETEUM-FrontEnd)  
  축제 기간 동안 학생들이 사용할 **실시간 채팅 서비스 ‘솜톡(Somtalk)’** 기능을 개발했습니다.  
  STOMP + SockJS 기반의 실시간 통신 구조를 구현하고,  
...
- 🔐 **FairLife – 웹코드보안 실습 프로젝트** — [Repository](https://github.com/seul99/FairLife)  
  Java 기반 암호학 프로젝트로, **RSA 암호화·전자서명·무결성 검증** 기능을 구현했습니다.  
